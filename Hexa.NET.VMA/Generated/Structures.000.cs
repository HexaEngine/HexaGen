...
namespace Hexa.NET.VMA
{
	...
	[NativeName(NativeNameType.StructOrClass, "VmaStlAllocator<VmaSuballocation>")]
	[StructLayout(LayoutKind.Sequential)]
	...
	public partial struct VmaDefragmentationInfo
	{
		...
		public unsafe VmaDefragmentationInfo(VmaDefragmentationFlagBits flags = default, VmaPool pool = default, ulong maxBytesPerPass = default, uint maxAllocationsPerPass = default, delegate*<uint> pfnBreakCallback = default, void* pBreakCallbackUserData = default)
		{
			Flags = flags;
			Pool = pool;
