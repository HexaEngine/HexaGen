...
namespace Hexa.NET.VMA
{
	...
	[return: NativeName(NativeNameType.Type, "VkResult")]
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	public unsafe delegate int VkMapMemory([NativeName(NativeNameType.Param, "device")] [NativeName(NativeNameType.Type, "VkDevice")] VkDevice device, [NativeName(NativeNameType.Param, "memory")] [NativeName(NativeNameType.Type, "VkDeviceMemory")] VkDeviceMemory memory, [NativeName(NativeNameType.Param, "offset")] [NativeName(NativeNameType.Type, "VkDeviceSize")] ulong offset, [NativeName(NativeNameType.Param, "size")] [NativeName(NativeNameType.Type, "VkDeviceSize")] ulong size, [NativeName(NativeNameType.Param, "flags")] [NativeName(NativeNameType.Type, "VkMemoryMapFlags")] VkMemoryMapFlags flags, [NativeName(NativeNameType.Param, "ppData")] [NativeName(NativeNameType.Type, "void**")] void** ppData);
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	public unsafe delegate VkBool32 PfnVmacheckdefragmentationbreakfunction([NativeName(NativeNameType.Param, "pUserData")] [NativeName(NativeNameType.Type, "void*")] void* pUserData);
