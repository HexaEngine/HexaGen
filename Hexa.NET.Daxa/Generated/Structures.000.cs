...
namespace Hexa.NET.Daxa
{
	...
	public partial struct VkAllocationCallbacks
	{
		...
		public unsafe VkAllocationCallbacks(void* pUserData = default, PFNVkAllocationFunction pfnAllocation = default, PFNVkReallocationFunction pfnReallocation = default, PFNVkFreeFunction pfnFree = default, PFNVkInternalAllocationNotification pfnInternalAllocation = default, PFNVkInternalFreeNotification pfnInternalFree = default)
		{
			PUserData = pUserData;
			PfnAllocation = (void*)Marshal.GetFunctionPointerForDelegate(pfnAllocation);
			PfnReallocation = (void*)Marshal.GetFunctionPointerForDelegate(pfnReallocation);
			PfnFree = (void*)Marshal.GetFunctionPointerForDelegate(pfnFree);
			PfnInternalAllocation = (void*)Marshal.GetFunctionPointerForDelegate(pfnInternalAllocation);
			PfnInternalFree = (void*)Marshal.GetFunctionPointerForDelegate(pfnInternalFree);
		}
