...
//based on imgui.h file version "1.90 WIP" 18995 from Dear ImGui https://github.com/ocornut/imgui
...
{    ImGuiConfigFlags ConfigFlags;
    ...
    ImWchar PlatformLocaleDecimalPoint;    bool WantCaptureMouse;
    ...
    float NavInputs[ImGuiNavInput_COUNT];    void* _UnusedPadding;    ImGuiContext* Ctx;
    ImVec2 MousePos;
    bool MouseDown[5];
    float MouseWheel;
    float MouseWheelH;
...
struct ImGuiContext
{
    ...
    bool ActiveIdUsingAllKeyboardKeys;    ImU32 ActiveIdUsingNavInputMask;
    ...
    ImVector_ImGuiNavTreeNodeData NavTreeNodeStack;    int BeginMenuCount;
...
struct ImGuiTableTempData
{
    int TableIndex;
    float LastTimeActive;
    float AngledheadersExtraWidth;    ImVec2 UserOuterSize;
...
CIMGUI_API bool igBeginChild_Str(const char* str_id,const ImVec2 size,bool border,ImGuiWindowFlags window_flags);
CIMGUI_API bool igBeginChild_ID(ImGuiID id,const ImVec2 size,bool border,ImGuiWindowFlags window_flags);
...
CIMGUI_API bool igBeginChildEx(const char* name,ImGuiID id,const ImVec2 size_arg,bool border,ImGuiWindowFlags window_flags);
...
CIMGUI_API bool igIsKeyChordPressed(ImGuiKeyChord key_chord,ImGuiID owner_id,ImGuiInputFlags flags);
