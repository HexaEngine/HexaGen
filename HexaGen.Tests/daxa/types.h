...
DAXA_EXPORT daxa_MemoryBlockInfo const * daxa_memory_block_info(daxa_MemoryBlock memory_block);

DAXA_EXPORT uint64_t daxa_memory_block_inc_refcnt(daxa_MemoryBlock memory_block);
DAXA_EXPORT uint64_t daxa_memory_block_dec_refcnt(daxa_MemoryBlock memory_block);
...
DAXA_EXPORT daxa_TimelineQueryPoolInfo const * daxa_timeline_query_pool_info(daxa_TimelineQueryPool timeline_query_pool);

DAXA_EXPORT DAXA_NO_DISCARD daxa_Result daxa_timeline_query_pool_query_results(daxa_TimelineQueryPool timeline_query_pool, uint32_t start, uint32_t count, uint64_t * out_results);

DAXA_EXPORT uint64_t daxa_timeline_query_pool_inc_refcnt(daxa_TimelineQueryPool timeline_query_pool);
DAXA_EXPORT uint64_t daxa_timeline_query_pool_dec_refcnt(daxa_TimelineQueryPool timeline_query_pool);
