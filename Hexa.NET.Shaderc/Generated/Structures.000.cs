...
namespace Hexa.NET.Shaderc
{
	...
	public partial struct ShadercIncludeResult
	{
		...
		/// <summary>/// To be documented./// </summary>		public unsafe ShadercIncludeResult(byte* sourceName = default, ulong sourceNameLength = default, byte* content = default, ulong contentLength = default, void* userData = default)
		{
