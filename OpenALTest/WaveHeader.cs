namespace OpenALTest
{
    ...
    public struct WaveHeader
    {
        ...
        public int GetBufferFormat()
        {
            ...
            else if (NumChannels == 1 && BitsPerSample == 32)
            {
                format = OpenAL.AL_FORMAT_MONO_FLOAT32;
            }
            ...
            else if (NumChannels == 2 && BitsPerSample == 32)
            {
                format = OpenAL.AL_FORMAT_STEREO_FLOAT32;
            }
            else
            {
