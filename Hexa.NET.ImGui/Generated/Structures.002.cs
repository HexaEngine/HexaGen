...
namespace Hexa.NET.ImGui
{
	...
	public partial struct ImFontConfig
	{
		...
		/// <summary>/// To be documented./// </summary>		public unsafe ImFontConfig(void* fontData = default, int fontDataSize = default, bool fontDataOwnedByAtlas = default, int fontNo = default, float sizePixels = default, int oversampleH = default, int oversampleV = default, bool pixelSnapH = default, Vector2 glyphExtraSpacing = default, Vector2 glyphOffset = default, ushort* glyphRanges = default, float glyphMinAdvanceX = default, float glyphMaxAdvanceX = default, bool mergeMode = default, uint fontBuilderFlags = default, float rasterizerMultiply = default, ushort ellipsisChar = default, byte* name = default, ImFont* dstFont = default)
		{
			FontData = fontData;
		...
		/// <summary>/// To be documented./// </summary>		public unsafe ImFontConfig(void* fontData = default, int fontDataSize = default, bool fontDataOwnedByAtlas = default, int fontNo = default, float sizePixels = default, int oversampleH = default, int oversampleV = default, bool pixelSnapH = default, Vector2 glyphExtraSpacing = default, Vector2 glyphOffset = default, ushort* glyphRanges = default, float glyphMinAdvanceX = default, float glyphMaxAdvanceX = default, bool mergeMode = default, uint fontBuilderFlags = default, float rasterizerMultiply = default, ushort ellipsisChar = default, Span<byte> name = default, ImFont* dstFont = default)
		{
			FontData = fontData;
			FontDataSize = fontDataSize;
			FontDataOwnedByAtlas = fontDataOwnedByAtlas ? (byte)1 : (byte)0;
	...
	public partial struct ImVectorImTextureID
	{
		...
		/// <summary>/// To be documented./// </summary>		public unsafe ImVectorImTextureID(int size = default, int capacity = default, void** data = default)
		{
			Size = size;
			Capacity = capacity;
			Data = data;
	...
	public partial struct ImDrawCmdHeader
	{
		...
		/// <summary>/// To be documented./// </summary>		public unsafe ImDrawCmdHeader(Vector4 clipRect = default, void* textureId = default, uint vtxOffset = default)
		{
			ClipRect = clipRect;
			TextureId = textureId;
			VtxOffset = vtxOffset;
