...
namespace Hexa.NET.ImGui
{
	...
	/// To be documented.
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "ImPool_ImGuiMultiSelectState")]
	...
	public partial struct ImPoolImGuiMultiSelectState
	{
		...
		[NativeName(NativeNameType.Type, "ImVector_ImGuiMultiSelectState")]
		...
		/// To be documented.
		/// </summary>
		public unsafe ImPoolImGuiMultiSelectState(ImVectorImGuiMultiSelectState buf = default, ImGuiStorage map = default, int freeIdx = default, int aliveCount = default)
		{
			Buf = buf;
			Map = map;
			FreeIdx = freeIdx;
