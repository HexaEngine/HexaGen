...
namespace Hexa.NET.ImGui
{
	...
	/// To be documented.
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "ImVector_ImGuiMultiSelectState")]
	...
	public partial struct ImVectorImGuiMultiSelectState
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe ImVectorImGuiMultiSelectState(int size = default, int capacity = default, ImGuiMultiSelectState* data = default)
		{
			Size = size;
			Capacity = capacity;
			Data = data;
