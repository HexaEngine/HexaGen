...
namespace Hexa.NET.ImGui
{
	...
	/// To be documented.
	/// </summary>
	[NativeName(NativeNameType.StructOrClass, "ImVector_ImGuiMultiSelectTempData")]
	...
	public partial struct ImVectorImGuiMultiSelectTempData
	{
		...
		/// To be documented.
		/// </summary>
		public unsafe ImVectorImGuiMultiSelectTempData(int size = default, int capacity = default, ImGuiMultiSelectTempData* data = default)
		{
			Size = size;
			Capacity = capacity;
			Data = data;
